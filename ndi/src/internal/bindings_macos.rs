...
pub const NDILIB_LIBRARY_NAME: &'static [u8; 13usize] = b"libndi.dylib\0";
pub const NDILIB_REDIST_FOLDER: &'static [u8; 19usize] = b"NDI_RUNTIME_DIR_V5\0";
pub const NDILIB_REDIST_URL: &'static [u8; 31usize] = b"http://new.tk/NDIRedistV5Apple\0";
...
pub struct NdiDynLib {
    ...
    pub NDIlib_framesync_free_video: Result<
        ...
        ::libloading::Error,
    >,
    pub NDIlib_v5_load: Result<unsafe extern "C" fn() -> *const NDIlib_v5, ::libloading::Error>,
    pub NDIlib_v4_5_load: Result<unsafe extern "C" fn() -> *const NDIlib_v4_5, ::libloading::Error>,
...
impl NdiDynLib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let NDIlib_framesync_free_video = __library
            ...
            .map(|sym| *sym);
        let NDIlib_v5_load = __library.get(b"NDIlib_v5_load\0").map(|sym| *sym);
        let NDIlib_v4_5_load = __library.get(b"NDIlib_v4_5_load\0").map(|sym| *sym);
    ...
    pub unsafe fn NDIlib_v5_load(&self) -> *const NDIlib_v5 {
        (self
            .NDIlib_v5_load
            .as_ref()
            .expect("Expected function, got error."))()
    }
    pub unsafe fn NDIlib_v4_5_load(&self) -> *const NDIlib_v4_5 {
        (self
            .NDIlib_v4_5_load
            .as_ref()
            .expect("Expected function, got error."))()
